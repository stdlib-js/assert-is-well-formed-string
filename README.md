...
```javascript
import isWellFormedString from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-well-formed-string@v0.1.2-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/assert-is-well-formed-string/actions/workflows/test.yml/badge.svg?branch=v0.1.2
[test-url]: https://github.com/stdlib-js/assert-is-well-formed-string/actions/workflows/test.yml?query=branch:v0.1.2
